...
/**
 * Credits: Created by https://github.com/mairbek/rxjava-redis
    ...
    public static Observable<String> observe(final Jedis jedis, final String channel, final ExecutorService executor) {
        return Observable.defer(new Func0<Observable<String>>() {
            ...
            public Observable<String> call() {
                return Observable.create((Observable.OnSubscribe<String>) new RedisObservable(jedis, channel, executor));
            }
        });
    }
